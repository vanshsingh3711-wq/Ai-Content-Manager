...
import { Phone, PhoneAppScreen, PhonePayment } from '@ai-content-manager/motion-components';
...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center text-white py-12">
      <h1 className="text-3xl font-bold mb-4">PhonePayment Demo</h1>
      ...
      <div className="flex gap-16 items-center justify-center w-full max-w-7xl overflow-auto p-16">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <PhoneAppScreen
              header={{ title: "Secure Checkout", showBackButton: true }}
              currentFrame={30}
